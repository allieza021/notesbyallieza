  ...
  return (
    <div className="max-w-5xl mx-auto">
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="font-serif font-black text-3xl text-foreground">Dashboard</h1>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-10">
        {statCards.map(({ label, key, icon: Icon, color }) => (
          ...
          >
            ...
            <div className="text-3xl font-serif font-black text-foreground">{stats[key]}</div>
      ...
      <div className="bg-card rounded-2xl border border-border overflow-hidden">
        <div className="flex items-center justify-between p-6 border-b border-border">
          <h2 className="font-serif font-bold text-lg text-foreground">Recent Posts</h2>
          <Link
            href="/admin/blogs"
        ...
        {recentBlogs.length === 0 ? (
          <div className="text-center py-16 px-6">
            ...
            <h3 className="font-serif font-bold text-lg text-foreground mb-2">No posts yet</h3>
          ...
          <div className="divide-y divide-border">
            {recentBlogs.map((blog) => (
              <div key={blog.id} className="flex items-center gap-4 px-6 py-4 hover:bg-muted/40 transition-colors">
